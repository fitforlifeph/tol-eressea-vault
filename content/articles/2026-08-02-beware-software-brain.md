...
saved: 2026-08-02T04:43:45.419619+00:00
...
Software brain is powerful stuff. It’s a way of thinking that basically created our modern world. Marc Andreessen, the literal embodiment of software brain, called it in 2011 when he wrote the piece [“Why software is eating the world”](https://www.wsj.com/articles/SB10001424053111903480904576512250915629460) as an op-ed in *The Wall Street Journal*. But software thinking has been turbocharged by AI in a way that I think helps explain the enormous gap between how excited the tech industry is about the technology and how regular people are growing to dislike it more and more over time.

In fact, the polling on this is so strong, I think it’s fair to say that a lot of people *hate* AI, and that [Gen Z in particular seems to hate AI](/ai-artificial-intelligence/909687/gen-z-doesnt-like-ai-gallup) more and more as they encounter it. There’s that *NBC News* poll [showing AI with worse favorability than ICE](/ai-artificial-intelligence/891724/nbc-news-march-2026-poll-ai-ice) and only a little bit above the war in Iran and the Democrats generally. That’s with nearly two thirds of respondents saying they used ChatGPT or Copilot in the last month. Quinnipiac just found that [over half of Americans think AI will do more harm than good](https://poll.qu.edu/poll-release?releaseid=3955), while more than 80 percent of people were either very concerned or somewhat concerned about the technology. Only 35 percent of people were excited about it.
...
Now, I obviously talk to a lot of tech executives and policy people here on *Decoder*, and I will tell you, they all know AI isn’t popular, and they can all see how that’s playing out in real life. Here’s Microsoft CEO Satya Nadella talking about how the tech industry [needs to make the case](https://www.youtube.com/watch?v=JapZJVcA1B4) for the investments it’s making in AI:
...
I think it’s safe to say that the tech industry and AI have not earned any of that social permission yet. Politicians from both sides of the aisle are opposing data center buildouts. Politicians in local communities that support data centers are getting voted out of office. And in the most depressing reminder of how much political violence has become a part of everyday American life, politicians who’ve supported data centers have [had their houses shot at](https://www.pbs.org/newshour/nation/indianapolis-councilman-says-shots-fired-at-home-and-no-data-centers-note-left-at-door). OpenAI CEO Sam Altman has [had Molotov cocktails thrown at his house](/ai-artificial-intelligence/911778/ai-violence-sam-altman-home).

I also think it’s incredibly important for our politicians and tech executives to make sure our political process makes people feel empowered, not helpless.
...
But that doesn’t always work. Here’s an example: Elon Musk and DOGE showed up in the government, and the first thing they did was [take control of a bunch of databases](/the-vergecast/608189/elon-musk-doge-coup-goverment-vergecast). And they ran into the undeniable fact that the databases aren’t reality, and DOGE [ended in hilarious failure](/news/827390/doge-is-no-more-and-in-its-wake-only-chaos). It turns out software brain has a limit — the government isn’t software. People aren’t computers, and they don’t live in automatable loops that can be neatly captured in databases.
...
Let me offer you another example that I think about all the time, especially as AI finds real fit as a business tool. It’s the idea that AI is coming for lawyers and the legal system. The AI industry loves to talk about not needing lawyers anymore, which is already getting all kinds of people into [all kinds of trouble](https://www.nytimes.com/2026/04/21/nyregion/sullivan-cromwell-ai-hallucination.html?smid=nytcore-ios-share). But I get it. I’ve spent a lot of time with lawyers. I used to be a lawyer. My wife is still a lawyer. Some of my best friends are lawyers.
...
(I am far from the first person with this idea, by the way. Larry Lessig wrote a book called [Code and Other Laws of Cyberspace in 2000](https://lessig.org/images/resources/1999-Code.pdf). It’s just as relevant today as it was a quarter century ago.)

This intoxicating similarity between law and code trips people up all the time. People are constantly trying to issue commands to society at large like it’s a computer that will obey instructions. There are examples of this big and small — my favorite are those [Facebook forwards](https://www.snopes.com/fact-check/new-facebook-rule-meta/) insisting Mark Zuckerberg does not have the right to publish people’s photos. Honestly, I look at these, and I think it would be *great* if the law was actually code. Maybe things would be more predictable. Maybe we’d feel more in control.
...
Law isn’t actually code, and society and courts aren’t computers.
...
Bridget McCormack, who used to be the chief justice of the Michigan Supreme Court, [was on *Decoder* a few months ago](/podcast/877299/ai-arbitrator-bridget-mccormack-aaa-arbitration-interview) pitching a fully automated AI arbitration system. Her argument to me was that people perceive the traditional legal system to be so unfair that they will accept a worse outcome from an automated system as more fair as long as they feel heard. And if there’s one thing AI can do, it’s sit there and listen all day and night.
...
<sub>Questions or comments about this episode? Hit us up at decoder@theverge.com. We really do read every email!</sub>
