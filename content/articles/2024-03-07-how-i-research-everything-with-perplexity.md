...
saved: 2024-03-07T07:18:45.777357+00:00
created: 2024-03-07T07:18:45.777357+00:00
source: "https://hulry.com/what-is-perplexity-ai/"
estimated_pages: 14
status: complete
draft: false
pdf_url: "https://archive.javierpgomez.com/articles/2024-03-07-how-i-research-everything-with-perplexity.pdf"
archive_url: "https://web.archive.org/web/https://hulry.com/what-is-perplexity-ai/"
tags: []
---

Perplexity was my gateway to the world of AI and the various AI-powered tools that crop up every day.
...
Frustrated, I decided to try this new tool in the market called [Perplexity](https://www.perplexity.ai/?ref=hulry.com), which was supposed to help search and understand information on the Web more efficiently.
...
I was not fixated on portability since I would use these drives at home. The more important factors were the read/write speed of the drive and data durability since I was looking for a long-term backup for [my YouTube videos](https://www.youtube.com/@hulry?ref=hulry.com) and other important files.
...
What Perplexity does might seem similar to what [ChatGPT](https://chat.openai.com/?ref=hulry.com) or [Google Gemini](https://gemini.google.com/?ref=hulry.com) do, but there's a key difference:
...
I'm writing a book on Japanese philosophies, and one of its chapters is about the practice of forest bathing called [Shinrin-yoku](https://en.wikipedia.org/wiki/Shinrin-yoku?ref=hulry.com).
...
I was curious about the process and the costs involved in self-publishing a book via Amazon's [Kindle Direct Publishing](https://kdp.amazon.com/?ref=hulry.com) (KDP) service.
...
As always, every pricing detail and information was backed by a credible source, Amazon's website in this case, so I know this [AI tool isn't hallucinating](https://zapier.com/blog/ai-hallucinations/?ref=hulry.com) and giving me false information.
...
At the time of writing this blog post, [Perplexity leverages OpenAI's GPT-3.5 model](https://blog.perplexity.ai/technical-faq/what-model-does-perplexity-use-and-what-is-the-perplexity-model?ref=hulry.com) to process all search data and turn them into concise answers.

But since I've subscribed to Perplexity Pro, I can rewrite any answer using a model of my choice.

I get a rewrite option under every answer, which I can use to rewrite the current answer using a different model, say [GPT-4](https://openai.com/gpt-4?ref=hulry.com), [Claude 2.1](https://www.anthropic.com/news/claude-2-1?ref=hulry.com) or [Mistral Large](https://mistral.ai/news/mistral-large/?ref=hulry.com).
...
Perplexity offers an option to generate illustrations in their premium subscription, but I have not seen any usable results. Even after selecting my preferred image generation model to [DALL•E 3](https://openai.com/dall-e-3?ref=hulry.com).

For example, here's a side-by-side comparison of the same prompt to generate an illustration of the [story of the Gordian knot](https://www.britannica.com/topic/Gordian-knot?ref=hulry.com) in a halftone style:
...
I could pay [Midjourney](https://www.midjourney.com/?ref=hulry.com) $10/month to substitute for Perplexity in image generation and have an overall lower cost than subscribing to both Perplexity Pro and ChatGPT Plus, but getting consistent results in the style I want from Midjourney is a pain I would prefer dodging.
...
For most cases, Perplexity, assisted by Pro Search, has replaced Google and [ChatGPT for me](https://hulry.com/how-to-use-chatgpt/), but I still hang on to them as a fallback.
...
When I subscribed to [Perplexity Pro](https://hlry.at/perplexity?ref=hulry.com) a month ago, I set a reminder on my calendar to decide whether to renew the subscription for another month.
...
Download Perplexity for [iOS](https://www.perplexity.ai/iphone?ref=hulry.com) or [Android](https://www.perplexity.ai/android?ref=hulry.com) on your phone, and the next time you have a curious feeling about something you've heard or read or have a question about any product you're looking to buy, search it on Perplexity.
...
After that, if you're considering upgrading to Perplexity Pro, you can use my [link to get a $10 credit](https://hlry.at/perplexity?ref=hulry.com) on your subscription.
