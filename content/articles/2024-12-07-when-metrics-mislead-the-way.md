---
title: "When Metrics Mislead the Way"
author: "Rahul Chowdhury"
publication: "Hulry"
published: 2024-11-06
saved: 2024-12-07T09:26:08.706196+00:00
created: 2024-12-07T09:26:08.706196+00:00
source: "https://hulry.com/goodharts-law/"
estimated_pages: 9
status: complete
draft: false
pdf_url: "https://archive.javierpgomez.com/articles/2024-12-07-when-metrics-mislead-the-way.pdf"
archive_url: "https://web.archive.org/web/https://hulry.com/goodharts-law/"
tags: []
---

When a measure becomes a target, it ceases to be a good measure.

An adage often attributed to [the British economist Charles Goodhart](https://en.wikipedia.org/wiki/Charles_Goodhart?ref=hulry.com) is as applicable today as in 1975.
...
This is where [Goodhart's Law](https://en.wikipedia.org/wiki/Goodhart%27s_law?ref=hulry.com) helps nudge us into the right path.
...
Metrics are helpful. They allow us to see things clearly and [project our future options and plans](https://hulry.com/summaries/the-present/#shaping-your-future).

The problem appears when we get too wrapped up in it.

Obsessing over numbers often detaches us from the goal we began with — especially if we're focused too much on chasing the wrong metrics. [We aim to game the system](https://hulry.com/firesides/gamification/) to meet a target number rather than making progress in the right direction.
...
We had a process for every new feature development of our app where a team would understand the business requirements, convert that into [an RFC document](https://leaddev.com/software-quality/thorough-team-guide-rfcs?ref=hulry.com) illustrating how the practical implementation would look and discuss with the entire team for their input before proceeding with the development.
...
1. **For the commentator:** They were robbing themselves of the opportunity to think diversely and grow as software engineers because, to them, the important thing was that they put a comment to their name on a shared document. Some comments and questions were so redundant that if the author had read the entire RFC before punching in their comments, they would've found their questions already addressed a few paragraphs below.
2. **For the team:** Plenty of time was lost answering the redundant questions in a time-limited session, leaving the thoughtful, out-of-the-box queries unattended or pushed for shallow reviews.
...
Social media platforms like **Threads** and **X** pay people [cash based on how many impressions](https://help.instagram.com/2449746995226910?ref=hulry.com) and [how much engagement their posts get](https://help.x.com/en/using-x/creator-revenue-sharing?ref=hulry.com) on the platform.
...
This creates a subpar experience for the platform's users, degrading its trust and quality over time. The problem has been so rampant that [Meta has finally acknowledged this behaviour](https://www.theverge.com/2024/10/7/24264382/threads-engagement-bait-problem-mosseri-meta?ref=hulry.com) and is working on combating the issue.
...
The invention of personal health trackers, such as fitness bands, [glucose monitoring patches](https://my.clevelandclinic.org/health/articles/continuous-glucose-monitoring-cgm?ref=hulry.com), and sleep tracker rings, has caused more stress and turmoil than it has contributed to good health.

Take sleep tracking, for example. You slip on a fitness band on your arm or [a smart ring like Oura](https://ouraring.com/?ref=hulry.com) on your finger and go to bed, hoping for a good night's sleep.
...
This isn't a hypothetical situation; the problem is very much [real and even has a name: orthosomnia](https://www.theguardian.com/lifeandstyle/2024/oct/15/sleep-perfectionists-the-exhausting-rise-of-orthosomnia?ref=hulry.com).
...
For years, I have [prioritised North Star principles](https://hulry.com/firesides/north-star/) over chasing metrics in my work, and they have worked well.
...
Recently, to boost my social media presence, I set a goal of posting something on [Hulry's Threads account](https://www.threads.net/@thehulry?ref=hulry.com) every Monday through Saturday, ideally twice daily.

While this started on a good note because I had a [backlog of helpful tips and tricks](https://hulry.com/collect-ideas-resources/) to share, the quality dwindled when I started keeping up with my set target, even though I didn't have anything interesting to share.
...
[Lean teams often make the most breakthroughs](https://bdickason.com/posts/small-teams-win/?ref=hulry.com) because they work together on a meaningful problem instead of chasing superficial metrics. This helps not only the company but also the individuals, who gain enviable skills in solving complex problems and growing further in their careers.
...
The recent [rotting of Google search](https://www.wheresyoured.at/the-men-who-killed-google/?ref=hulry.com) is a classic example.
...
Search result pages today are [littered with too many ads](https://www.youtube.com/watch?v=uSGVk2KVokQ&ref=hulry.com), taking attention away from the helpful results and duping the user into clicking ads for revenue:
...
Now that Google faces competition from AI products like [ChatGPT](https://hulry.com/how-to-use-chatgpt/) and [Perplexity](https://hulry.com/what-is-perplexity-ai/), it's even more vital that Google readjusts their target to follow its long-lost principle of good experience to keep its dominant position in the search engine market.
...
When I'm short on time, I substitute light stretching or [a 7-minute workout](https://seven.app/?ref=hulry.com) for my regular weightlifting routine or simply skip exercising for the day.
...
Having a North Star principle or [purpose for every corner](https://hulry.com/firesides/purposeful-life/) of your life helps here.
