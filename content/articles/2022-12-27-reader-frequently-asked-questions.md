...
author: "Daniel Doyon"
publication: "Readwise Blog"
published: 2023-08-10
saved: 2022-12-27T06:20:29.278037+00:00
created: 2022-12-27T06:20:29.278037+00:00
...
- Add URL-based saving FAQ in
**Adding Content to Reader** section- Add bulk restore from Trash FAQ in
**Basics** section- Add colored dot status indicators FAQ in
**Basics** section
### March 6, 2026


- Add FAQ about where the Listen button is in long-form reading mode in
**Text-to-Speech (TTS)** section- Add side panel open/close FAQ in
**Appearance** section- Update tagged highlights FAQ with new Manage Tags page features in
**Highlights, Tags, and Notes** section- Update bundle sharing FAQ and add bundle refresh FAQ in
**Sharing** section- Update Apple Pencil FAQ and add two-column tablet view FAQ in
**Appearance** and **Highlights, Tags, and Notes** sections- Add offline document caching FAQ in
**Basics** section- Overhaul
**Text-to-Speech (TTS)** section: replace misalignment FAQ with return/jump button FAQs, move and expand languages FAQ- Add Ghostreader disable toggle FAQ in
**Ghostreader** section- Add RSS feed refresh interval FAQ in
**Feed** section- Add PDF auto-highlighting FAQ in
**PDFs** section
### December 16, 2025


- Explain how to add podcasts in
**Adding Content to Reader** section
### November 19, 2025


- Add how to undo in
**Basics** section- Explain what the "Unsubscribe" button does for email subscriptions
- Explain how to switch from text view to original view for emails
- Remove Pocket integration information now that it's
[fully shut down](https://support.mozilla.org/en-US/kb/future-of-pocket)
### October 15, 2025
...
- Add "bump to top" instructions to
**Navigation** section- Explain how to change the iOS app icon
- Add section for
**E-ink Devices**- Add long-form reading mode to
**Appearance** section- Update Ghostreader models
### May 6, 2025
...
**Note:** PDFs in original view don't have this smooth stylus support yet, but if you [switch over to the text view](/reader/docs/faqs/pdfs#how-do-i-customize-the-appearance-of-a-pdf-while-reading) it will work great.
...
**Tip:** To make the visual line between the columns a bit sharper (and to make it feel more like reading a real book), you might also like to turn on [justified text](/reader/docs/faqs/eink#justify-text) while reading in this view.
...
To create your own bundle, first [create a filtered view](/reader/docs/faqs/filtered-views) in the web app, then click the down chevron next to its name and select `Enable public link`. You can optionally add a cover image to spice up the public landing page.
