---
title: "Superstition, Sciencestition, and How to Stop Overthinking Your Food Choices"
...
I came to believe (as I still do) that [**food is not merely fuel**](https://www.precisionnutrition.com/food-is-not-fuel). That [**no single diet**](https://www.precisionnutrition.com/best-diet) is universally superior. And that there are a lot more considerations to eating than “how does nutrient X affect pathway Y in my body?”.

Don’t get me wrong: Understanding the scientific properties of food is helpful—to a point.

There’s a reason why PN teaches the science of nutrition in the [**Precision Nutrition Level 1 Nutrition Coaching Certification**](https://www.precisionnutrition.com/nutrition-certification-level-1-presale-list): because it’s useful to understand the “why” behind nutrition recommendations before you start doling them out to clients.
...
Sometimes, I share pictures of what I eat on [**Instagram**](https://www.instagram.com/drjohnberardi/).

Either [**a single meal**](https://www.instagram.com/p/CVKuMlAMCDx/) or [**an entire day of meals**](https://www.instagram.com/p/CUkSz6KrSwq/).

People are always asking me how I eat so, occasionally, I oblige by sharing my own meals or [**what our family is eating**](https://www.instagram.com/p/CLwS_n9rIzZ/).
...
Here’s an example [**I posted about recently**](https://www.instagram.com/p/CVFkmIYsHWz/).
...
[**Nutrition science is complicated**](https://www.precisionnutrition.com/nutrition-science-is-so-confusing), and relatively early in its evolution. This means there’s a fair bit of research out there that’s open to interpretation.
...
So I visit [**PubMed**](https://pubmed.ncbi.nlm.nih.gov/) (the world’s largest index of biomedical research) and search for scientific studies that support the use of lemon water.

Or I Google something like: “health benefits of lemon water in the morning*.*” (Try it. [**You’ll get lots of results**](https://lmgtfy.app/?q=health+benefits+of+drinking+lemon+water).)
...
Just as [**“health” is more than “not being sick,”**](https://www.precisionnutrition.com/deep-health) food is more than just nutrients.
...
In a [**recent Instagram post**](https://www.instagram.com/p/CUmrG0hte_x/), I mentioned that I’ve been “zero alcohol” for three years now and that I think it’s contributed, in small part, to some positive health outcomes, particularly around hormonal health.
...
But just because I don’t drink doesn’t mean I search for all the info I can find about why alcohol is bad for everyone and then proselytize against it. I understand it serves different needs for different people. And that some of those, on balance, could be healthy… in the right context. (For examples, check out: [**Would I be healthier if I quit drinking?**](https://www.precisionnutrition.com/quit-drinking))
...
If you’d like to learn more, consider the **[PN Level 1 Nutrition Coaching Certification.](https://www.precisionnutrition.com/nutrition-certification-level-1-register-now)** (You can enroll now at a big discount.)