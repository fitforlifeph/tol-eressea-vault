---
title: "Aerobic Self-Assessment for Mountain Athletes"
author: "Uphill Athlete"
publication: "Uphill Athlete"
published: 2026-04-18
saved: 2024-12-08T03:55:05.174214+00:00
created: 2024-12-08T03:55:05.174214+00:00
source: "https://uphillathlete.com/aerobic-training/aerobic-anaerobic-threshold-self-assessment/"
estimated_pages: 12
status: complete
draft: false
...
- **Heart Rate:** AeT to Lactate Threshold (LT)/AnT
...
We were not inventing anything new here. Exercise science uses the ventilatory markers rate and depth of breathing for this same purpose when doing a Gas Exchange Test (GET, discussed later), albeit with more accuracy. However, once we began to work with untrained and less well-trained climbers, we discovered that this nice, simple test no longer worked. For that reason, we no longer treat nose breathing or the talk test as a way to find your AeT. We use it now as a quick daily check that an easy effort is genuinely easy, and we point you to the Heart Rate Drift Test below when the goal is to actually locate the threshold.
...
If you are conducting your Heart Rate Drift test on a running track, be sure to read [this very short post](https://uphillathlete.com/aerobic-training/connecting-watch-heart-rate-monitor-training-peaks/) to get the most accurate data.
...
Find out how to locate a testing lab [here.](https://uphillathlete.com/aerobic-training/lab-metabolic-test/)
...
#### Continuous AeT (Ongoing Monitoring)

Every option above shares one limitation: each one captures your aerobic threshold on a single day. Continuous AeT works differently. Rather than asking you to perform a test, it reads your aerobic threshold from the training you are already doing and proposes an updated reading every week. It rests on the same physiology as the Heart Rate Drift Test above, and we developed it by checking its readings against drift-test and lab results. Because it runs from your normal training, its job is not to find your number once but to show you how your aerobic base is changing while the change is happening. It is worth its own section, which follows below.

**Continuous AeT Takeaways**

Pluses: No extra workouts or equipment. Updates weekly from training you are already doing. Most useful read next to your AnT, where the gap between them shows your Aerobic Deficiency.

Minuses: Needs about four weeks of quality heart-rate data before it settles, and enough steady, sport-specific training to read from. Best paired with a baseline drift or lab test rather than used on its own. Available inside our Training Groups and coaching.

Rating: 4 stars for ongoing monitoring

## Continuous AeT: From a One-Time Test to Ongoing Monitoring

Every test in the previous section shares one limitation. It captures your aerobic threshold on a single day, and then your fitness keeps moving. Train consistently and your AeT climbs, sometimes by 25 to 30 beats per minute over a year of correct base work. The snapshot you took in January is quietly out of date by spring, and you have no way of seeing it drift except by testing again.

Continuous AeT closes that gap. Instead of asking you to perform a test, it reads your aerobic threshold from the training you are already doing and proposes an updated reading every week. It rests on the same principle as the Heart Rate Drift Test above: the relationship between your heart rate and your pace at a steady effort tells us where your aerobic ceiling sits. We built it by checking its readings against drift-test and lab results across many athletes, and it now ships to every athlete in our Training Groups.

The word proposes matters. Continuous AeT does not set your training zones over your head, and it is not a grade on your fitness. It makes a weekly proposal, and you govern what to do with it. If you train with a UA coach, your coach helps you govern it, reading the number against your recent training and your own felt experience. The reading is the start of a conversation, not the end of one.

On its own, a single week’s number means little. What it is for is the trend and the framework it sits inside. Watched over weeks, the reading makes the slow, patient work of base building visible while it is happening. Placed next to your anaerobic threshold, it tells you something more useful still: the distance between your AeT and your AnT is the measure of Aerobic Deficiency. When that gap is wide, the work is patient aerobic base training below AeT. When it narrows, you have earned the room to add intensity. A reading understood inside that framework is the difference between a number on a screen and a training decision.

Continuous AeT does not replace the tests above, it builds on them. A clean Heart Rate Drift Test or lab test is still the right way to establish your first baseline, and the right tool to reach for when you return from a layoff or illness and want a fresh, deliberate read. Continuous AeT also needs roughly four weeks of quality heart-rate data before it settles, and it can only read the training you give it. Spend a month hiking with almost no steady running and your running threshold will have little to read from, and the reading will reflect that honestly. Its strength is the job the one-time tests cannot do: tracking change over time, with no extra workouts and no test day.

You can see Continuous AeT in action inside our [Training Groups](https://uphillathlete.com/training-groups/), where it reads every athlete’s aerobic threshold from week to week and a coach helps make sense of it.

## Anaerobic or Lactate Threshold Self-Assessment
