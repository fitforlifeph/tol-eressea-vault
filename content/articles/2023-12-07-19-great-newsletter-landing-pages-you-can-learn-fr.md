---
title: "19 Great Newsletter Landing Pages You Can Learn From"
author: "Dan Oshinsky"
publication: "Inbox Collective"
published: 2023-11-29
saved: 2023-12-07T01:31:11.992200+00:00
created: 2023-12-07T01:31:11.992200+00:00
source: "https://inboxcollective.com/19-great-newsletter-landing-pages-you-can-learn-from/"
estimated_pages: 18
status: complete
draft: false
tags: []
...
Your newsletter landing page can be one of the biggest drivers of growth for your newsletter. It’s the place where you can make the big pitch to a reader about why they should subscribe to your newsletter.

Some newsletter platforms, like [Beehiiv](/aweber-beehiiv-convertkit-ghost-mailchimp-substack-which-is-the-right-esp-for-your-indie-newsletter/#beehiiv) or [Substack](/aweber-beehiiv-convertkit-ghost-mailchimp-substack-which-is-the-right-esp-for-your-indie-newsletter/#Substack), automatically build a landing page for you when you create an account. But many newsletter operators choose to create their own landing page to promote their newsletter. Why?
...
As I wrote about [in my guide to newsletter growth](/ways-to-grow-your-newsletter-list/), so many newsletter landing pages use the exact same language: “Sign up for my newsletter.”
...
6. **Some sort of verification tool built in —**[Spambots tend to target sign-up pages like these](/should-i-use-single-opt-in-or-double-opt-in-for-my-newsletter/) , so you want to keep these pages safe to maintain good deliverability. Have[reCAPTCHA (opens in new tab)](https://www.google.com/recaptcha/about/) or an email verification tool like[Kickbox (opens in new tab)](https://app.kickbox.com/signup?fp_ref=dan16) built into your sign-up box so you can keep your list clean.
...
You don’t need to have the perfect page on Day 1 — start with the essentials, and then work to improve it over time! I’ve even published a guide with questions to ask to help you improve your landing page — [use this resource](/13-questions-to-ask-to-improve-your-newsletter-sign-up-page/) to make your page a little bit better.
...
They’ve used [oAuth (opens in new tab)](https://oauth.net/) — a reader can choose their preferred login option, register without typing in their email address, and then The Athletic will get their email via the oAuth integration. It’s a great option for readers on a mobile device — it simplifies the login process and eliminates the chance that a reader leaves a typo in their email address. (No more readers accidentally typing in @gnail.com!)
...
And here’s a unique feature of this landing page: Nik lists off some of his clients (Priyanka Chopra, Pitbull, Hint Water) as proof that he knows what he’s talking about. For [an expert-driven newsletter](/five-types-of-indie-newsletter-business-models/#Expert), that’s a smart tactic to help differentiate his newsletter.
...
- **Add social proof that readers love your newsletter —** This could include testimonials from readers to showcase why readers love the product, or stats around list size or engagement to prove that your newsletter is worth reading. Several of the newsletters above are using a tool called[Senja (opens in new tab)](https://www.senja.io?via=dan89) to collect and display testimonials on their page.
...
- **Lean into progressive profiling —**  Don’t ask for too much information upfront. If you want to ask for a first or last name, that’s OK — but ask after they sign up. Tools like[RightMessage (opens in new tab)](https://rightmessage.com?fp_ref=dan37) or[Typeform (opens in new tab)](http://typeform.com) can help you collect the data and sync it with your email service provider.
- **Protect your page —** Have reCAPTCHA or an email verification tool like[Kickbox (opens in new tab)](https://app.kickbox.com/signup?fp_ref=dan16) built into your sign-up box. Spambots tend to target sign-up pages like these, so you want to keep these pages safe to maintain good deliverability.
- **Test out different versions of the page to see which performs best —**  Don’t just assume that the first version of the page will convert well. Consider using tools like[CrazyEgg (opens in new tab)](https://www.crazyegg.com/) or[Optimizely (opens in new tab)](https://www.optimizely.com/) to A/B test multiple versions of the page and see which drives the most sign-ups. Even a small bump in conversion rate might lead to significantly more newsletter subscriptions in the long run.

And if you’re looking for even more landing page ideas, [here are 13 questions to ask](/13-questions-to-ask-to-improve-your-newsletter-sign-up-page/) to help you improve your page.

**Thanks to our sponsor**

The stories you’re reading on inboxcollective.com are made possible thanks to the generous support of our fall sponsor, [Who Sponsors Stuff](https://signup.whosponsorsstuff.com/sales-pro/?source=notanewsletter), which gives you and your team the tools to quickly find and reach out to relevant sponsors for your newsletter. They track 350+ newsletters, have direct contact information for 6,000+ sponsors, and keep you on the cutting edge of who’s spending money in the email advertising space. [Find out how their Sales Pro product can supercharge your ad sales operation today](https://signup.whosponsorsstuff.com/sales-pro/?source=notanewsletter).