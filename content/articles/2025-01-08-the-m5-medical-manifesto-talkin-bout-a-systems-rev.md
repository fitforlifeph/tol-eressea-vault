---
title: "The M⁵ Medical Manifesto: Talkin’ Bout a (Systems) Revolution"
author: "Nita Jain"
publication: "Mind the Gap"
published: 2025-01-07
saved: 2025-01-08T07:04:54.964664+00:00
created: 2025-01-08T07:04:54.964664+00:00
source: "https://www.nitajain.com/p/m5-medical-manifesto?publication_id=15792&post_id=154294146&isFreemail=true&r=1owzhk&triedRedirect=true"
estimated_pages: 9
status: complete
draft: false
...
# The M⁵ Medical Manifesto: Talkin’ Bout a (Systems) Revolution

### A modest proposal to radically overhaul healthcare

“Nothing in biology makes sense except in the light of evolution.”

First espoused by evolutionary biologist Theodosius Dobzhansky in his [seminal 1973 essay](https://doi.org/10.2307/4444260), most scientists agree with this consensus opinion. But relying on empirical observation alone can lead to myopic conclusions. We know that structure determines function. Red blood cells are non-nucleated in order to carry more oxygen. Opposable thumbs allow us to grasp objects of different shapes.
...
The appendix, long considered an anatomical anachronism, was recently shown [to serve as a safe-house](https://pubmed.ncbi.nlm.nih.gov/21370495/) for commensal gut bacteria during bouts of gastrointestinal illness. Our assumption that lymph nodes are absent in brain tissue was later proven erroneous by the discovery of [the glymphatic system](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4636982/).
...
But every single human member is host to trillions of other microbial members, including bacteria, archaea, fungi, protists, and viruses. Evolution acts not on humans but [holobionts](https://www.nitajain.com/i/156693135/the-missing-link-in-the-evolutionary-record), a term that encompasses hosts plus all their microbial symbionts. In other words, evolution acts on ecosystems.
...
Treatment of tuberculosis often destroys the bone marrow, statins are notorious for depleting carnitine and coenzyme Q10, and the collateral damage of antibiotics is akin to that caused by trying to kill a mosquito with an AK-47. Many drugs exhibit toxicity through mechanisms that [damage the mitochondria](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-021-04285-3) and interfere with cellular respiration.
...
Why are patients with one autoimmune disease extremely likely to have at least one other? Which mechanisms explain why Ehlers-Danlos syndrome (EDS), postural orthostatic tachycardia syndrome (POTS), and mast cell activation syndrome (MCAS) [form a diagnostic triad](<https://www.jacionline.org/article/S0091-6749(14)02927-3/fulltext>)? How can we account for the high degree of overlap between neurodivergent conditions like autism, ADHD, OCD, and dyslexia?

The high incidence of certain disease comorbidities can be explained if we look a little deeper. We can assign molecular mechanisms to clinical presentations formerly considered idiopathic. In late 19th century, surgeon Sir Benjamin Brodie [voiced his opposition](https://www.google.com/books/edition/Divide_and_Conquer/bqvmCwAAQBAJ) to medical specialization as follows:
...
[Subclinical magnesium deficiency](https://openheart.bmj.com/content/5/1/e000668), for example, predisposes individuals to the inflammaging common to many complex chronic diseases, including atherosclerosis, diabetes, hypertension, osteoporosis, and cardiovascular disease.
...
In a typical adult, the activity of sodium-potassium ATPase pumps is estimated to account for [20-40% of resting energy expenditure](https://lpi.oregonstate.edu/mic/minerals/sodium), and their importance in sustaining life can’t be overstated.

Certain genetic mutations that interfere with proper functioning of the sodium-potassium pump have been shown to [cause rapid onset dystonia-parkinsonism](<https://www.cell.com/neuron/fulltext/S0896-6273(04)00426-X>), characterized by involuntary muscle contractions and the inability to voluntarily move one’s muscles and limbs. Alcohol is thought to impair motor coordination by [inhibiting sodium-potassium pumps](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4417229/) in the cerebellum.
...
This duality of discrete states—healthy or sick—creates a false dichotomy. Disability is often dynamic, chronic disease symptoms wax and wane, and many individuals considered healthy may actually be in a prodromal period where symptoms have not yet been made manifest. Expanding the angles from which we collect data can help us approach health and disease in more nuanced ways and move from preventing pathology to optimizing well-being.
...
The cost of genomic sequencing [has fallen precipitously](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8982374/) over the last 20 years, at a much higher rate than that predicted by Moore’s law. The cost of employing other types of sequencing technologies will likely follow suit. The benefits of utilizing multi-omics data have already been demonstrated in several settings.

Researchers at the Institute for Systems Biology recently used proteomics, metabolomics, clinical laboratory assays, genetic risk scores, and gut microbiome composition data to develop a measure called [biological BMI](https://www.nature.com/articles/s41591-023-02283-x), which more accurately reflects metabolic health than classically measured BMI.

Genomic, epigenomic, transcriptomic, and proteomic profiling of certain cancers [has been used to](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8334347/) identify clinical subtypes, model cancer pathophysiology, and predict potential drug targets.
