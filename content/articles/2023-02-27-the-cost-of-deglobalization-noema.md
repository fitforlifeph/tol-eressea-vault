---
title: "The Cost Of Deglobalization | NOEMA"
author: "Kevin Xu"
publication: "NOEMA"
published: 2023-02-23
saved: 2023-02-27T00:02:23.125497+00:00
created: 2023-02-27T00:02:23.125497+00:00
source: "https://www.noemamag.com/the-cost-of-deglobalization/"
estimated_pages: 10
status: complete
draft: false
tags: []
...
When the Taiwan Semiconductor Manufacturing Company’s Arizona fabrication facility held its “tool-in” ceremony last December, Morris Chang, who founded the company in 1987, called this event the “[end of the beginning](https://interconnect.substack.com/p/globalization-is-dead-and-no-one)” — as in the end of the beginning of TSMC’s $40 billion investment in Arizona, but also the “end” of the beginning of deglobalization. Even though the tide of deglobalization, friendshoring and onshoring has been gaining strength for many years, TSMC’s foray into the U.S. is a landmark moment of this important shift. 
...
The semiconductor industry was globalizing long before “globalization” became the norm, as Chris Miller chronicled in his book, “[Chip War](https://www.amazon.com/Chip-War-Worlds-Critical-Technology/dp/1982172002).” More than perhaps any other company, TSMC epitomizes all the forces of globalization — from free trade and hyper-specialization to international supply chains anchored on a presumed sense of geopolitical stability. When globalization was all well and good, these forces interacted and interconnected without much friction or impediments, propelling companies like TSMC to incredible success.  

Now that TSMC is at the center of the reverse trend, its endeavors in Arizona also serve as a case study of how friendshoring really works and how much deglobalization really costs. The chip-making juggernaut revealed some of these details in its Q4 2022 [earnings report](https://investor.tsmc.com/english/encrypt/files/encrypt_file/reports/2023-01/84f1ef6f66c6c90b05d2e581066a01a8f1c4f410/TSMC%204Q22%20Transcript.pdf). 
...
During the earnings call, [Wendell Huang](https://seekingalpha.com/article/4569491-taiwan-semiconductor-manufacturing-company-limited-tsm-q4-2022-earnings-call-transcript), TSMC’s CFO, was asked repeatedly about the cost difference between Arizona and Taiwan. His response was: 
...
This category is perhaps the most straightforward to understand, though it has some uniquely “American” elements too. Building and operating fabs in Arizona will subject TSMC to higher labor costs in the form of salary, benefits and labor relations. Applying the median software engineer salary as a heuristic, the [U.S. salary](https://www.levels.fyi/t/software-engineer?countryId=254) is roughly three times more than [Taiwan’s](https://www.levels.fyi/t/software-engineer/locations/taiwan?city=17410). Employer-assumed benefits like healthcare, insurance and retirement contributions usually add another 25-30% to each employee. Healthcare, in particular, may present a jarring reality to TSMC — Taiwan has arguably one of the most cost-effective healthcare systems in the world, whereas the U.S. most certainly does not.
...
The relative strengths and weaknesses of labor relations depend on the state. Some are legally and culturally more union friendly, others less so. Arizona is ranked 40th in its percentage of [union workers](https://www.bls.gov/news.release/union2.t05.htm) — a not so union-friendly state. This likely played a role in TSMC selecting Arizona as its “American home.” 

On the other hand, Ohio, the [location](https://www.intel.com/content/www/us/en/corporate-responsibility/intel-in-ohio.html) of Intel’s planned $20 billion fab, is ranked 13th — a more pro-union state. Interestingly, Intel already has a sizable [footprint](https://www.cnet.com/pictures/a-look-inside-intels-mammoth-arizona-chipmaking-fab/) in Arizona but decided to expand in Ohio instead. Keep in mind that most of this semiconductor-focused friendshoring is happening under an unabashedly pro-union U.S. president. How many “good-paying union jobs” a fab creates may be a factor in how much of the [$39 billion](https://www.whitehouse.gov/briefing-room/statements-releases/2022/08/09/fact-sheet-chips-and-science-act-will-lower-costs-create-jobs-strengthen-supply-chains-and-counter-china/) manufacturing incentives from the CHIPS and Science Act Intel or TSMC or another company would receive to subsidize its investment. 
...
How massive? TSMC acquired more than [1,000 acres](https://www.azcentral.com/story/money/business/2022/12/07/what-to-know-phoenix-taiwan-semiconductor-factory/69707994007/) of land north of Phoenix to house its ambitions in America. This land is large enough for six fabs (though only two are being planned right now). This land is also designed to bring TSMC’s [Grand Alliance](https://www.tsmc.com/english/dedicatedFoundry/grandAlliance) of partners and suppliers physically closer, while allowing for enough space to build any new roads, housing and other construction that TSMC deems necessary. The goal is to recreate, as much as possible, the physically tight and operationally efficient ecosystem that made Taiwan, a small island, uniquely suited for high-quality, high-capacity chipmaking. 

Chang [explained](https://mp.weixin.qq.com/s/ZkOrEXOTMWchhL3PRSYIXg#rd) what made Taiwan uniquely suited to semiconductor manufacturing in a speech in 2021. Among its many advantages, he described in great detail how Taiwan’s high-speed rail system enabled the nimble deployment of thousands of workers between Hsinchu, Tainan and Taichung — TSMC’s three manufacturing hubs. High-speed rail can carry a large number of workers from one location to another in a day or less, which gives TSMC the ability to maximize worker productivity and output without needing to worry about losing talent or employee attrition, because families don’t need to relocate.

Recreating that environment is a tall order for Arizona. California’s high-speed rail [debacle](https://www.nytimes.com/2022/10/09/us/california-high-speed-rail-politics.html) is a cautionary tale: Costs ballooned and progress slowed largely due to horse-trading between state, local and county officials, all of whom saw the project as an opportunity for political enrichment. 

In a federalist system, where governance is separated into multiple layers that each have a certain level of autonomy, this division of labor produces artificial inefficiencies, red tape and many opportunities for “[regulatory capture](https://en.wikipedia.org/wiki/Regulatory_capture)” — where regulators behave to advance the commercial or ideological goal of a narrow special interest, not the broader public interest. Such costly bureaucratic processes are not nearly as big of a problem in places where large development projects are centrally executed, like Taiwan and South Korea — both of which, not coincidentally, are chip-making powerhouses.
...
Huang diplomatically framed this problem as “learning curve costs.” But Chang was more blunt when addressing this issue in his [speech](https://interconnect.substack.com/p/globalization-is-dead-and-no-one) during the “tool-in” ceremony: “We hired almost 600 engineers here a year and a half ago, we sent them to Taiwan, and they were under training in Taiwan for one year to a year and a half. In the meantime, about the same number of Taiwan engineers underwent training in Taiwan also. So before we see a single wafer, we have about more than a thousand people being trained. This, I think, is a very good sign that we are prepared.”

Putting it differently, TSMC has been having such a hard time finding enough quality recruits to hire that it is [resorting](https://www.wsj.com/articles/tsmcs-arizona-chip-plant-awaiting-biden-visit-faces-birthing-pains-11670236129?mod=Searchresults_pos2&page=1) to bringing on less-qualified workers and dispatching them for lengthy training in Taiwan. And it is hiring just as many engineers in Taiwan to go through the same process and be [dispatched](https://www.wsj.com/articles/tsmcs-arizona-chip-plant-awaiting-biden-visit-faces-birthing-pains-11670236129?mod=Searchresults_pos2&page=1) to Arizona to further close the knowledge gap. 
...
This challenge is not unique in the semiconductor industry — it’s systemic in U.S. manufacturing. According to a [study](https://www2.deloitte.com/us/en/insights/industry/manufacturing/manufacturing-industry-diversity.html) by Deloitte and the Manufacturing Institute, the overall manufacturing skills gap in the U.S. could result in 2.1 million unfilled jobs by 2030. The surveyed executives are having trouble filling both unskilled entry-level openings and middle-skill roles across many functions.

At least there is funding in the CHIPS and Science Act — [$13.2 billion](https://www.whitehouse.gov/briefing-room/statements-releases/2022/08/09/fact-sheet-chips-and-science-act-will-lower-costs-create-jobs-strengthen-supply-chains-and-counter-china/) — earmarked for R&D and workforce development. A nationwide skills training program to fill knowledge gaps, starting with areas most relevant to semiconductor manufacturing and expanding from there, is urgently needed.
...
The story of [Mastercraft Furniture](https://www.oregonlive.com/business/2015/05/oregon_furniture_maker_once_la.html), a former Oregon-based furniture maker, is one such example. Years of efforts competing with Asian companies ended in Mastercraft’s bankruptcy. When foreign furniture makers need a solution to circumvent geopolitical tension, “[nearshoring](https://www.nytimes.com/2023/02/03/business/china-mexico-trade.html?smid=tw-share)” to Mexico under the new North American [trade pact](https://www.nytimes.com/2020/07/01/business/economy/usmca-takes-effect.html) is more than sufficient and has better economics. Other industries like automobile wheels, construction equipment components and small electronic parts have similar dynamics and look more like furniture-making than chip-making.
...
Some serious friendshoring is already underway. In partnership with Honda, LG is building a [$4.4 billion](https://www.reuters.com/business/autos-transportation/honda-motor-lg-energy-build-ev-battery-plant-ohio-nikkei-2022-08-29/) battery plant in the U.S. SK Group, another large South Korean battery producer, is pouring [$7 billion](https://www.reuters.com/business/sk-group-22-bln-us-investment-create-secure-supply-chains-white-house-2022-07-26/) into building gigafactories in Tennessee and Kentucky — a joint venture with Ford. Going against the tide of worsening tension between the U.S. and China, Ford is also building a new [$3.5 billion](https://www.nytimes.com/2023/02/13/business/energy-environment/ford-catl-electric-vehicle-battery.html) battery plant in Michigan with CATL’s technology. Meanwhile, GM is partnering with Lithium Americas (an interesting friendshoring candidate that has strong ties to Argentina and whose stock is trading on the Toronto Stock Exchange) to [mine](https://www.cnbc.com/2023/01/31/gm-to-invest-650-million-in-lithium-company-to-support-ev-growth.html) lithium in Nevada for batteries.

With the Inflation Reduction Act’s subsidies for EV purchases and an industry-wide [price reduction](https://www.consumerreports.org/hybrids-evs/electric-cars-are-becoming-less-expensive-a6548270716/), consumers have not had to pay more for the friendshoring of lithium-ion battery production just yet. Of course, a federal subsidy is simply a reprioritization of tax dollars already levied from taxpayers, who are always the ultimate bearers of these costs. The only question is whether reprioritizing this money to building strategic redundancy instead of funding new innovation, all in the name of national security and competitiveness, is worth the price.
...
There is also no official definition of what a “friend” is. While grandiose alliance frameworks like the [Quad](https://en.wikipedia.org/wiki/Quadrilateral_Security_Dialogue) and the [Chip 4 initiative](https://asia.nikkei.com/Business/Tech/Semiconductors/U.S.-chip-alliance-against-China-tests-South-Korea-s-loyalty) delineate who is friends with whom, being a “good friend” in the age of deglobalization requires more than regular summits and photo-ops.
