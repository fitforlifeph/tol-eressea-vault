---
title: "An appetizer: purpose | Meaningness"
author: ""
publication: "Meaningness"
published: 2010-10-07
saved: 2024-12-07T21:17:29.817935+00:00
created: 2024-12-07T21:17:29.817935+00:00
source: "https://meaningness.com/an-appetizer-purpose"
estimated_pages: 4
status: complete
draft: false
...
Let’s start this book in the middle.  The [main course](/stances-toc) is a ways off, and I want to give you a taste now.

Let’s talk about *purpose*.  (Purpose is one of the
[dimensions] of meaningness discussed in this book.)
...
Let’s go through these alternatives briefly.  I will explain each one in
detail in [the middle part](/stances-toc) of the book.

## Five confused attitudes to purpose

Everything has a fixed purpose, given by some sort of
fundamental ordering principle of the universe.  (This might be God,
or Fate, or the [Cosmic Plan](https://meaningness.com/no-cosmic-plan), or something.)  Humans too
have a specific role to play in the proper order of the universe.


This is the [stance](https://meaningness.com/stances-trump-systems) of [eternalism](https://meaningness.com/preview-eternalism-and-nihilism).  It may be 
...
wrong for particular situations.
...
This is the stance of [nihilism](https://meaningness.com/preview-eternalism-and-nihilism).  It appears quite logical.  It
...
This is the stance of [materialism](https://meaningness.com/materialism).  Realistically, most
people adopt this stance much of the time.  However, at times everyone
*does* recognize the value of altruistic and creative purposes,
...
quickly, and then you are left craving the next, better thing.
...
This is the stance of [mission](https://meaningness.com/mission).  The problem is that no one
...
opportunities for enjoyment and satisfaction.
...
This is the stance of *existentialism*.<sup>[1](#fn_1)</sup>
It is based on the
...
Choosing at random would be pointless, and impossible; and what *purely* personal
basis could you have for choosing one purpose over another?
...
1. [1.](#fn_mark_1) Actually, it is more-or-less what existentialists called “authenticity.”  Using that term would be confusing, because existentialist “authenticity” hasn’t got all that much to do with the everyday sense of the word.