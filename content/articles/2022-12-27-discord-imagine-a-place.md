---
title: "Discord: Imagine a Place"
author: "Packy McCormick"
publication: "Not Boring by Packy McCormick"
published: 2021-11-08
saved: 2022-12-27T06:20:50.715698+00:00
created: 2022-12-27T06:20:50.715698+00:00
source: "https://www.notboring.co/p/discord-imagine-a-place"
estimated_pages: 34
status: complete
draft: false
...
🎧 *To get this essay straight in your ears: listen on **[Spotify](https://open.spotify.com/show/6k1YLBvORRMyosKy3x1xIl?si=Dpy4iCK7Q52S1L431zsT0g)** or **[Apple Podcasts](https://podcasts.apple.com/us/podcast/not-boring/id1527421931) (shortly)***

**Today’s Not Boring is brought to you by...** [Sprig](https://sprig.com/?&utm_source=paid_packy_2021-11-08&utm_medium=email&utm_campaign=ad)

[Sprig](https://sprig.com/?&utm_source=paid_packy_2021-11-08&utm_medium=email&utm_campaign=ad) is your all-in-one product research platform. If you’ve read Not Boring to the end, wow, thank you, and you’ll be familiar with Sprig. It’s what I use every week to get feedback from all of you, quickly and easily. 
...
*Sprig’s two newest solutions — [video interviews](https://sprig.com/video-interviews.html?&utm_source=paid_packy_2021-11-08&utm_medium=email&utm_campaign=ad) and [concept testing](https://sprig.com/concept-tests.html?&utm_source=paid_packy_2021-11-08&utm_medium=email&utm_campaign=ad) — let companies have async video conversations with users, and even share Figma designs at the same time to get rich feedback on concepts and prototypes that are still in development. If you build products, you should just [try it for yourself](https://app.sprig.com/signup?&utm_source=paid_packy_2021-11-08&utm_medium=email&utm_campaign=ad). It’s all of your product research tools, in one place.* 

*The Sprig team knows that once teams start using it, they don’t stop, so it’s offering a [free onboarding and 30-day trial](https://sprig.com/trial/?&utm_source=paid_packy_2021-11-08&utm_medium=email&utm_campaign=ad) to any enterprise company (~100,000+ users).* 
...
But Discord is too big, too potentially consequential to write alone. So when [Mario Gabriele](https://twitter.com/home) tweeted that he was planning to go deeper on Discord, I texted him, and we decided to join forces.

Mario is one of the best writers on the internet and has been on fire as he goes deeper down the web3 rabbit hole, writing bangers on [OpenSea](https://www.readthegeneralist.com/briefing/opensea) and [FTX](https://www.readthegeneralist.com/briefing/ftx-1), coordinating a group piece on [DAOs](https://www.readthegeneralist.com/briefing/dao) with the best people in the space, and even launching his own NFT project, [Philosophical Foxes](https://opensea.io/collection/philosophicalfoxes). (I proudly own one named Second Life.) If you don’t subscribe to The Generalist, [subscribe now](https://www.readthegeneralist.com/).
...
During a conversation about Aurora’s future, the young executive [made](https://www.businessinsider.com/this-26-year-old-just-sold-his-company-for-104-million-2011-5) an off-hand comment: 
...
*[Quartz](https://qz.com/2034087/chat-app-discord-is-shedding-its-gamer-roots/)* attempted to capture the multi-faceted magic via analogy mashup: “Picture a combination of Slack, AOL Instant Messenger, Zoom, and a sketchy chat room, and you have something approximating Discord.” 

*[PCGamer](https://www.pcgamer.com/please-enjoy-discord-while-its-still-good/)* explained all of the things that Discord lets its users do:
...
In 2019, [Taylor Lorenz wrote an article](https://www.theatlantic.com/technology/archive/2019/03/how-discord-went-mainstream-influencers/584671/) in *The Atlantic* about the influencer invasion of Discord. Instead of letting Facebook and Twitter’s algorithm-based feeds mediate their relationships with their fans, influencers began spinning up Discords in droves. According to *[Forbes](https://www.forbes.com/sites/abrambrown/2020/06/30/discord-was-once-the-alt-rights-favorite-chat-app-now-its-gone-mainstream-and-scored-a-new-35-billion-valuation/?sh=34dd0ca2b6b2)*, the article, and Discord’s growing non-gamer user base, surprised Citron and Vishnevskiy. 

No strangers to letting user behaviors pull them in new directions, they dug in.

When Discord sent out a 23 question survey to its community, they discovered that over 30% of Discord’s users weren’t using the product primarily for gaming. They were hosting book clubs, friends’ group chats, fan communities, and even companies. Discord had become the internet’s “third place.” As Citron [told Patrick O’Shaughnessy](https://joincolossus.com/episodes/15742336/citron-building-the-third-place?tab=transcript): 

*I read the book, [The Great Good Place](https://www.amazon.com/dp/B00F21YF94/ref=dp-kindle-redirect?_encoding=UTF8&btkr=1), by Ray Oldenburg, which was written in the '80s where he actually talks about this, and starts to put labels and words to describe the concepts of how these **third places** work. And as I was reading the book, I was just like, "Holy crap, this is what we built, except it's digital. This is incredible."*
...
On its face, Discord looks a lot like Slack. It’s organized into **Servers** -- each community’s space -- and within each server, there are **Channels**, including **Voice Channels**, in which users can also choose to turn on [video](https://blog.discord.com/wave-hello-to-server-video-85dcef1128f0) for up to 25 people. Voice channels can be always on, and users can drop in and drop out casually, like hopping onto a couch with friends. 
...
Perhaps the most notable part of the Discord platform outside of its chat functionality and social architecture is its burgeoning ecosystem of bots. In a [2020 blog post](https://discord.com/blog/the-future-of-bots-on-discord), Discord announced that more than 3 *million* bots had been created, with some used across millions of servers. For comparison, Slack boasts 2,400 apps in its directory. (Of course, this is not a strictly fair comparison, given that many bots may be deprecated, but it is still directionally interesting.)
...
[MEE6](https://mee6.xyz/) is particularly popular in the final category. It’s used by more than 14 million servers to create custom welcome messages, proactively boot bad actors, assign community roles, and grant “XP” (“experience points”) for participation. 

More creative options are available — [IdleRPG](https://idlerpg.xyz/) is one of them. Once integrated with a server, community members can participate in a *Dungeons & Dragons*-style role playing game, orchestrated through chat commands. Given Discord’s popularity with gamers, it’s little surprise Idle is frequently used. 

Discord’s bot ecosystem extends into crypto. In a recent piece on [DAOs](https://www.readthegeneralist.com/briefing/dao), The Generalist outlined a few integrations that have caught on with the web3 world. In particular, products like [Collab.Land](https://collab.land/) — which allows holders of unique tokens or NFTs to access private channels — have become essential. Other players in this subspace include [Tip](https://tip.cc/) (accept crypto tips!) and [Piggy](https://piggy.gg/) (an RPG with crypto rewards). 
...
In time, Discord could extend bot discovery through intelligent suggestions. Anyone, for example, that notes they’re starting a crypto server should be prompted to use Collab.Land, or a similar tool. Anyone that is spinning up a new anime fandom may want to check out [Mudae](https://www.patreon.com/mudae), a multiplayer manga bot. 
...
For example, Stir’s [Newsroom](http://usestir.com/newsroom) (coming soon 👀) takes Discord’s chaotic existence for granted and builds a clean, organized collaboration interface on top of Discord’s conversational firehose. 
...
Discord is estimated to have 300 million users, with 150 million of them active on a monthly basis. They’re spread out across 19 million active servers per week spanning gaming, investing, politics, anime, and much, much more.
...
Prominent communities include **[Axie Infinity](https://www.notboring.co/p/infinity-revenue-infinity-possibilities)** (800,000 members), **[Sushi](https://www.readthegeneralist.com/briefing/sushi)** (150,000 members), **[Solana](https://www.notboring.co/p/solana-summer)** (86,000), **Loot** (83,000 members), **Uniswap** (72,000 members), and **Bored Ape Yacht Club** (69,000, nice). 
...
For comparison, Facebook, errrr, Meta has 3 billion MAUs across its properties, Snap has 347 million, and Reddit has 430 million. Twitter stopped reporting MAUs in 2019, and instead reports monetizable daily active users (mDAUs), of which it has 211 million. It had 396 million MAUs at last count. That means that, just six years old, Discord is within striking distance of the social media giants (other than the behemoth, Meta), and is growing much faster than all of them.
...
In July 2012, **Phoenix Guild** [announced](https://www.pocketgamer.biz/news/42910/openfeint-founder-jason-citron-raises-11-million-for-post-pc-outfit-phoenix-guild/) a $1.1 million seed round from YouWeb alongside top VC funds **Accel** and **General Catalyst** to build the “Blizzard of the post-PC era” as an antidote to the “lame F2P sims” that Citron said everyone was building. 

The following year, the renamed **Hammer & Chisel** [raised](https://www.pocketgamer.biz/news/55374/hammer-and-chisel-raises-87-million-to-bring-moba-to-tablets/) an $8.7 million Series A, led by Mitch Lasky at **Benchmark,** to create the *Fates Forever,* “the first MOBA [multiplayer online battle arena] crafted exclusively for tablets.” 

**Hammer & Chisel** raised a Series B, too, $4.5 million from Benchmark and [Tencent](https://www.notboring.co/p/tencent-the-ultimate-outsider) in February 2015. The investment valued the company at $45 million. In the [VentureBeat](https://venturebeat.com/2015/02/10/fates-forever-mobile-game-maker-hammer-chisel-raises-funding-from-benchmark-and-tencent/) [article](https://venturebeat.com/2015/02/10/fates-forever-mobile-game-maker-hammer-chisel-raises-funding-from-benchmark-and-tencent/) announcing the raise, Citron called the company’s flagship game, “the first step in a journey to crafting a meaningful games company.” 
...
Within three years, Discord raised a $50 million Series D from **Index** and **IVP**, a $50 million Series E from [existing investors](https://www.wsj.com/articles/discord-valued-at-1-65-billion-in-new-funding-round-1524163751) that made the company a unicorn at a $1.65B valuation, and a $150 million Series F led by Neil Mehta at **Greenoaks** that [broke the $2 billion valuation mark](https://techcrunch.com/2018/12/21/gaming-chat-startup-discord-raises-150m-surpassing-2b-valuation/). 

Citron & Co took an uncharacteristically long eighteen month fundraising pause in 2019 and early 2020 before raising a $100 million Series G from Index in June 2020 at a rumored $3.5 billion valuation and another $100 million Series H from Greenoaks in December 2020 at $7 billion.

This past March, Microsoft tried to scoop up Discord for a [rumored $10-12 billion](https://www.wsj.com/articles/microsoft-is-in-exclusive-talks-to-acquire-discord-11616715164?mod=article_inline), but talks [fell apart in April](https://www.wsj.com/articles/microsoft-is-in-exclusive-talks-to-acquire-discord-11616715164?mod=article_inline). It would have been a snug fit with Microsoft’s sneaky strong gaming portfolio, which includes XBox, Minecraft, and recent acquisition [ZeniMax](https://www.zenimax.com/). Plus, Discord certainly would have been a technical upgrade to Microsoft’s Teams product, and a strategic weapon in the corporate race for the Metaverse. But Microsoft’s $12 billion offer wasn’t enough to get the deal done. Just a few months later, the decision to rebuff Redmond paid off. 
...
Some of the most compelling investment opportunities are those that have a clear investment thesis around the core business with a free call option sprinkled on top. Meta is an ads behemoth with a Metaverse kicker. Tencent makes China’s most dominant app plus one of the world’s best venture portfolios (including Discord) *plus* a [Metaverse kicker](https://www.notboring.co/p/tencents-dreams).
...
Surveys play an important role in Discord’s recent history. In 2019, results from a survey pushed the company to zig, widen its aperture, and welcome all user types. So this recent survey, which [@HsakaTrades posted](https://twitter.com/HsakaTrades/status/1428119126329872387?s=20) on Twitter, might hint at Discord’s next zag:
...
The idea is simple: imagine that every Discord account came with a crypto wallet. Maybe this wallet would support the Ethereum ecosystem, like [Metamask](https://metamask.io/) or [Rainbow](https://rainbow.me/), or Solana, like [Phantom](https://phantom.app/). Ideally, given Discord’s role as Switzerland, it would create a wallet that worked across chains, and given Discord’s large non-crypto user base, the wallet might not look like a crypto wallet at all on its face. Both ideas sound simple but present real technical and UI challenges. It may be worth the lift. 
...
- Token-gating certain servers and channels within Discord itself without needing to click away to a third-party solution like [collab.land](https://collab.land/) .
...
Earlier this week, Mario tweeted a dumb little meme:

It’s no coincidence that in the “DAO starter pack,” Discord comes first. It has become an essential part of how [DAOs](https://www.readthegeneralist.com/briefing/dao) communicate and coordinate; embedded in the culture. 
...
Though likely technically complex — and admittedly a deviation from the core product — adding features to support this behavior could be extremely powerful and lucrative. The end result might look something like a *contextual* [OpenSea](https://www.readthegeneralist.com/briefing/opensea) or [FTX](https://www.readthegeneralist.com/briefing/ftx-1) — an exchange that begins with discussion and is capable of capturing the intent it generates. 
...
Phelps himself [predicts](https://twitter.com/divine_economy/status/1455540236390436869?s=20) that there won’t be a web3 Discord, but an unbundling of Discord into its component parts, with specific web3 tools forming a Transformers version of the product. 
...
It’s fitting that as living on the internet becomes more and more like playing a [Great Online Game](https://www.notboring.co/p/the-great-online-game), the place that its citizens choose to gather is a chat app originally built by gamers, for gamers. 
...
[Loved](https://a.sprig.com/7656535650385f7932397e7369643a3530323033?r=5) | [Great](https://a.sprig.com/7656535650385f7932397e7369643a3530323033?r=4) | [Good](https://a.sprig.com/7656535650385f7932397e7369643a3530323033?r=3) | [Meh](https://a.sprig.com/7656535650385f7932397e7369643a3530323033?r=2) | [Bad](https://a.sprig.com/7656535650385f7932397e7369643a3530323033?r=1)

(That’s [Sprig](https://app.sprig.com/signup?&utm_source=paid_packy_2021-11-08&utm_medium=email&utm_campaign=ad) 👆)
