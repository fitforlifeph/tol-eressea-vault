---
title: "How to Start Earning in Web3"
author: "Kash Dhanda"
publication: "The Superteam Blog"
published: 2022-03-13
saved: 2022-12-27T06:20:50.557636+00:00
created: 2022-12-27T06:20:50.557636+00:00
source: "https://superteam.substack.com/p/how-to-start-earning-in-web3"
estimated_pages: 11
status: complete
draft: false
pdf_url: "https://archive.javierpgomez.com/articles/2022-12-27-how-to-start-earning-in-web3.pdf"
archive_url: "https://web.archive.org/web/https://superteam.substack.com/p/how-to-start-earning-in-web3"
tags: []
---

# How to Start Earning in Web3

### Strategies, tactics, and resources to help you get going
...
The rest of this essay is a guide for anyone who wants to understand the earning landscape in Web3. By the time you’re done reading, you’ll know where to look for earning opportunities, how to approach those opportunities, and how to successfully make it in Web3. Throughout, we’ll include links to resources and success stories from our Members at [Superteam](https://superteam.fun/). 
...
1. Start Contributing to DAOs
2. Become a Bounty Hunter
3. Receive a Grant
4. Join a Fellowship
5. Join a Project Full Time
...
To start contributing to DAOs, the first step is to find a few DAOs with missions that resonate with you. Use a site like [DiscoverDAOs](https://discoverdaos.com/) or [DeepDAO](https://deepdao.io/) to find these communities. You might explore learning DAOs like [Odyssey DAO](https://www.odysseydao.com/) and [The Invisible College](https://www.invisiblecollege.xyz/), social DAOs like [Friends with Benefits](https://www.fwb.help/) and [Kraus Haus](https://www.krausehouse.club/), media DAOs like [Bankless](https://www.bankless.community/) and [Forefront](https://www.forefront.club/), service DAOs like [Superteam](https://superteam.fun/) or [Vector](https://vectordao.com/), or any one of the long list of protocol DAOs. 
...
DAO contribution is a great route for those who are just getting their feet wet in Web3 and want a low-commitment avenue to contributing. Superteam Member [Raj Karia](https://twitter.com/rajkaria_) used this strategy at Questbook and has since become an essential part of the team.
...
At Superteam, we regularly offer bounties with [$1,000+ prize pools.](https://superteam.fun/500-bounties) Join our [Discord server](https://discord.com/invite/Mq3ReaekgG) to be the first to know when they go live. In addition, check out platforms like:

Bounties are a great option for those who have a full time job and want to work in crypto during their nights/weekends. It’s also a good fit for those with low costs of living who can afford to cover their expenses on irregular income. Superteam Member [Aditya Shetty](https://twitter.com/aditay7s) has won thousands of dollars while working a day job, just through bounties. 
...
- **Ecosystem Agnostic**
  - [Web3 Grants](https://web3.foundation/grants/) (Development and Research)
  - [Metacartel Grants](https://www.metacartel.org/grants/) (dApps)
  - [Gitcoin Grants](https://gitcoin.co/grants/explorer/?page=1&limit=12&me=false&sort_option=weighted_shuffle&collection_id=false&network=mainnet&state=active&profile=false&sub_round_slug=false&collections_page=1&grant_regions=&grant_types=&grant_tags=&tenants=&idle=false&featured=true&round_type=false&tab=grants) (Public Goods for Web3)
  - [Unicef Innovation Fund](https://www.unicefinnovationfund.org/) (Social Entrepreneurship)
  - [Meta Gamma Delta](https://metagammadelta.com/grants/) (Female Founders)
  - [Radicle](https://radicle.mirror.xyz/7RDTvdxABVndpZge9VT09Ku5JXD8lCCCpLRRZaVrtJU) (Open Source Development)
- **Ecosystem Specific**
  - [Solana India Grants](https://superteam.fun/instagrants/solana-foundation-india-grants) (Indian founders in the Solana ecosystem)
  - [Solrazr Instagrants](https://superteam.fun/instagrants/get-up-to-10k-to-grow-the-solana-ecosystem) (Solana Ecosystem)
  - [Solana Foundation Grants](https://solana.foundation/grants)
  - [Chainlink Grants](https://chain.link/community/grants#apply-for-a-grant)
  - [PoolTogether Grants](https://poolgrants.org/)
  - [The Stable Fund](https://docs.ethhub.io/other/funds/stable-fund/) (Maker/DAI)
  - [Consensys Grants](https://consensys.net/grants/) (Ethereum Ecosystem)
...
In case you think grants are only available to those with decades of experience, you should know that Superteam Member [Kunal Bagaria](https://twitter.com/kb24x7) has earned tens of thousands of dollars through grants at the ripe old age of 16. 
...
- [Gitcoin Kernal](https://kernel.community/en/) (General Web3)
- [Friends with Benefits](https://www.fwb.help/fellowships) (for Artists/Creatives)
- [Ethereum Foundation Fellowship](https://fellowship.ethereum.foundation/) (Ethereum specific)
- [Binance X Fellowship](https://binancex.dev/fellowship.html) (Open source projects)
- [OnDeck](https://www.beondeck.com/) (General Web3 and Web2)
- [Solana India Fellowship](https://solana-india-fellowship.devfolio.co) (for Indians)
- [Le Crypto Fellowship](https://www.lecryptofellowship.com/) (for Europeans)
...
1. **Say Goodbye to Climbing the Ladder**
2. **Say Hello to Risk Management** 
3. **Build Your Personal Distribution**
...
2. Tell people about what you’ve done.
...
*If you want to be notified of the most exciting Web3 work opportunities, join the [Superteam Talent Network](https://superteam.fun/find-work-in-web3). We’ll notify you when freelance and full-time opportunities specific to your interests become available so that you can kickstart your Web3 career.* 

*Special thanks to [Neil Schroff](https://twitter.com/neilshroff), [Aditya Shetty](https://twitter.com/aditay7s), [Saumya Saxena](https://twitter.com/saxenasaheb), [Raj Karia](https://twitter.com/rajkaria_), [Brij Dhanda](https://www.linkedin.com/search/results/all/?keywords=brij%20dhanda&origin=RICH_QUERY_SUGGESTION&position=1&searchId=abfc783e-28f7-4361-9e51-07eb54589e3d&sid=u3N), and [Sanah Dhanda](https://www.linkedin.com/in/sanah-sabharwal-8897111a/) for contributing feedback to this essay.*