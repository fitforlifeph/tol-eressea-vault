...
publication: "Fakebaldur"
published: 2026-05-14
saved: 2026-07-31T03:49:35.849780+00:00
source: "https://www.baldurbjarnason.com/2026/the-old-world-of-tech-is-dying/"
estimated_pages: 16
status: complete
draft: false
...
This colours academic thinking as well. Thomas Kuhn’s [ paradigm shift](https://en.wikipedia.org/wiki/Paradigm_shift), for example, on the face of it frames scientific progress as a series of singular revelatory events that each change an entire field of study in almost one go. But if you dig into the text itself, 

*The Structure of Scientific Revolutions*, the process it describes is one where the worldviews of scientists and academics change one by one, where many simply never adopt the new worldview – the one that more cohesively explains what they’ve been observing – and instead stick to preexisting models. Even the most sudden and dramatic paradigm shifts are processes of epistemic diffusion where the old and new models of truth coexist and interact. All of which is to say that Kuhn’s ideas lend themselves to a pluralistic interpretation provided you actually dig into the text itself, and it means that, if you squint, you could make the ideas work with theories of epistemic anarchism such as that of

[Paul Feyerabend](https://en.wikipedia.org/wiki/Paul_Feyerabend#Thought).
...
## The US technopolistic hegemony [#](#the-us-technopolistic-hegemony)

Reading that [Dmitry Sklyarov had been arrested for violating the US Digital Millennium Copyright Act](https://en.wikipedia.org/wiki/United_States_v._Elcom_Ltd.) was the moment I first truly understood how the [technopoly](https://en.wikipedia.org/wiki/Technopoly) of the US government and the tech industry worked.
...
## The global tech economy [#](#the-global-tech-economy)
...
## The hegemony ends [#](#the-hegemony-ends)
...
## The old is dying [#](#the-old-is-dying)
