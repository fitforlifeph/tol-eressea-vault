---
title: "The Shirky Principle: Institutions Try to Preserve the Problem to Which They Are the Solution"
author: ""
publication: "effectiviology.com"
published: 2026-01-01
saved: 2024-12-07T21:16:41.447951+00:00
created: 2024-12-07T21:16:41.447951+00:00
source: "https://effectiviology.com/shirky-principle/"
estimated_pages: 10
status: complete
draft: false
tags: []
...
An example of the Shirky principle are tax-filing companies who [lobby](http://web.archive.org/web/20210509181435/https:/www.propublica.org/article/inside-turbotax-20-year-fight-to-stop-americans-from-filing-their-taxes-for-free) the government to [prevent](http://web.archive.org/web/20210509175424/https:/www.propublica.org/article/filing-taxes-could-be-free-simple-hr-block-intuit-lobbying-against-it) it from [offering](http://web.archive.org/web/20210509181647/https:/www.politico.com/agenda/story/2018/07/18/tax-filing-congress-irs-000683/) a free and easy way to [file taxes](http://web.archive.org/web/20210416223809/https:/www.nytimes.com/2015/04/16/technology/personaltech/turbotax-or-irs-as-tax-preparer-intuit-has-a-favorite.html), to ensure that the companies can continue to make a profit. A similar example of this are private prison companies who [lobby](http://web.archive.org/web/20210509182458/https:/www.washingtonpost.com/posteverything/wp/2015/04/28/how-for-profit-prisons-have-become-the-biggest-lobby-no-one-is-talking-about/) the government to [support](http://web.archive.org/web/20210509184717/https:/www.theguardian.com/commentisfree/2012/sep/27/lawmakers-lobbyists-keep-lock-private-prison-business) policies that [increase](http://web.archive.org/web/20210509185251/https:/escholarship.org/uc/item/3qj7q63d) the number of [incarcerated](http://web.archive.org/web/20210509185809/https:/papers.ssrn.com/sol3/papers.cfm?abstract_id=2794145) people and the [duration](https://doi.org/10.1002/9781118519639.wbecpx175) of their incarceration.

Another [well-known](https://sagepub.com/en-us/nam/encyclopedia-of-social-media-and-politics/book239101) example of the Shirky principle is described in “[Cognitive Surplus](https://amzn.to/3tqsrZz)”, a book by Clay Shirky that contained one of the first discussions of this principle:
...
One real-world example of the Shirky effect in this context is the *cobra effect*. It [describes](https://doi.org/10.1057/s41302-021-00187-7) a [case](http://web.archive.org/web/20210510110107/https:/freakonomics.com/podcast/the-cobra-effect-a-new-freakonomics-radio-podcast/) where British colonial officials in Delhi (India), set a bounty on dead cobras, in order to reduce the cobra population. However, this led citizens to breed the cobras for profit, and eventually to release them when the bounty was canceled.
...
— From “Of rats, rice, and race: The great Hanoi rat massacre, an episode in French colonial history” (Vann, [2003](https://doi.org/10.1353/fch.2003.0027))



The Shirky principle was proposed in a [2010 blog post](http://web.archive.org/web/20210508141233/https:/kk.org/thetechnium/the-shirky-prin/) by Kevin Kelly, editor of *Wired* magazine, who based it on the speaking and writing of scholar Clay Shirky.

Specifically, Kelly attributed the adage that “Institutions will try to preserve the problem to which they are the solution” to a statement that Shirky made in a recent talk, and noted that similar statements were made by Shirky in an associated blog post (“[The Collapse of Complex Business Models](http://web.archive.org/web/20100404013927/http:/www.shirky.com/weblog/2010/04/the-collapse-of-complex-business-models/)”) and book (“[Cognitive Surplus](https://amzn.to/3tqsrZz)”). There, Shirky states that “an organization that commits to helping society manage a problem also commits itself to the preservation of that same problem, as its institutional existence hinges on society’s continued need for its management”.

In addition to mentioning the key quote that is now known as the Shirky principle, Kelly also says the following in his [blog post](http://web.archive.org/web/20210508141233/https:/kk.org/thetechnium/the-shirky-prin/):
...
*Note*: In [his post](http://web.archive.org/web/20210508141233/https:/kk.org/thetechnium/the-shirky-prin/), Kelly states that Shirky’s observation reminds him “of the clarity of the Peter Principle, which says that a person in an organization will be promoted to the level of their incompetence. At which point their past achievements will prevent them from being fired, but their incompetence at this new level will prevent them from being promoted again, so they stagnate in their incompetence.”.
...
- [***Cui bono***](https://effectiviology.com/cui-bono/) , which is a Latin phrase that means “who benefits?”, and which is used to suggest that there’s a high probability that those responsible for a certain event are the ones who stand to gain from it.
- [***Hanlon’s razor***](https://effectiviology.com/hanlons-razor/) , which is the adage that you should “never attribute to malice that which is adequately explained by stupidity”, and which, when applied broadly, suggests that when assessing people’s actions, you should not assume that they acted out of a desire to cause harm, as long as there is a reasonable alternative explanation.


[*Parkinson’s law*](https://effectiviology.com/parkinsons-law/) is the adage that “work expands so as to fill the time which is available for its completion” (or more generally, that “work expands to consume the resources available for its completion”). It relates to Shirky’s principle, since both concepts present a common way in which entities are inefficient or ineffective in dealing with problems that they’re supposed to solve.

Shirky’s principle also relates to another phenomenon that was [identified](https://doi.org/10.1088/1742-5468/2009/03/p03008) by Parkinson, whereby the growth of a bureaucratic or administrative body is often associated with a substantial decrease in its overall efficiency. This is [attributed](http://web.archive.org/web/20130331045219/http:/www.economist.com/node/14116121) to the desire of officials to increase the number of their subordinates, and to officials’ tendency to create work for each other.
