---
title: "The Ultimate Beginner’s Guide to Avalanche"
author: "Lost Worlds"
publication: "Medium"
published: 2022-01-31
saved: 2022-12-27T06:20:50.577438+00:00
created: 2022-12-27T06:20:50.577438+00:00
source: "https://lostworldsnfts.medium.com/the-ultimate-beginners-guide-to-avalanche-9b533551bd0d"
estimated_pages: 26
status: complete
draft: false
...
Metamask by default is set to the Ethereum network. What that means is that anything on the Avalanche network will not be able to connect to your wallet. Configuring and then switching to the Avalanche network is easy however by following the steps laid out [here](https://support.avax.network/en/articles/4626956-how-do-i-set-up-metamask-on-avalanche#:~:text=Go%20to%20https%3A%2F%2Fwallet,and%20access%20your%20Avalanche%20Wallet.&text=Now%20you%20can%20send%20the,wallet%20to%20your%20MetaMask%20wallet.&text=You%20now%20have%20AVAX%20on,start%20using%20Avalanche%20with%20MetaMask.).
...
If you would like to set up an Avalanche Wallet (and you should), simply go here: [https://wallet.avax.network/](https://wallet.avax.network/) and follow the easy prompts.
...
1. Go to [https://bridge.avax.network/](https://bridge.avax.network/)
2. Select “Ethereum to Avalanche”
3. Select the asset you want to bridge. It has to be Ethereum based but not necessarily Ethereum. For example, I can bridge USDT which is an ERC-20 (Ethereum) token
4. Hit transfer.
...
When it is over, you will have WETH.e in your wallet. The symbol is different (it is technically Wrapped Ether) but the value is the same. To see it in Metamask you will need to add WETH.e to your Metamask/wallet. A tutorial is [here](https://www.youtube.com/watch?v=vZqclPuPjMw&list=PLRHl-ulWK4-FPRA7SS1OrCOC8cOc2K8sP&index=4).
...
Proof of Stake, solves some issues regarding speed and cost other blockchains like Ethereum and Bitcoin face. You can learn more about proof of work (how Ethereum and Bitcoin work) and how it compares to proof of stake [here](https://www.coinbase.com/learn/crypto-basics/what-is-proof-of-work-or-proof-of-stake).
...
For example, one popular platform on Avalanche is called [BenQi](https://benqi.fi/). You can go to BenQi, launch the app and connect your wallet to the platform. You should come to something that looks like this.
...
1. **Receive rewards in the native token** : If you think a project is very sound and building toward something great, their token may rise in value meaning $100 in rewards from Platform A’s token can rise faster than the price of $AVAX, turning your $100 to something much greater.
2. **Higher APYs** : sometimes you may find a platform can offer a more competitive APY than the delegation rewards
3. **Collateral borrowing** : depositing your AVAX on BenQi allows you to take out a collateralized loan in another type of asset. We will talk more about the advantages of borrowing later on.

### **Staking on Avalaunch**

Another staking option is on [Avalaunch](https://launchpad.avalaunch.app/), a fundraising platform built on Avalanche. Avalaunch allows people to buy into a upcoming project’s token before the token is available for trading — this is called an Initial Dex Offering (IDO). Think of when a company IPOs and a series of insiders will get access to very cheap price of that stock. In DeFi, you are the insider and get to reap the advantage of getting a token so early on is that it will be at a very low price point.
...
On Avalanche, the simplest way to start earning fees from a liquidity pool is to go to [TraderJoexyz.com](https://traderjoexyz.com/#/home). Trader Joe (not the grocery store) is the largest and most popular decentralized exchange native to the Avalanche ecosystem.
...
- **Rugpull Watchdogs:** Organizations like[AVAX Rug Pull Prevention](https://twitter.com/AvaxDyor) research different projects and call out suspected rugs
...
- [OrcaDAO](https://app.avai.finance/)
- [Blizz](https://blizz.finance/)
...
1. Deposit DAI into BenQi (or other lending protocol)
2. Take out up to 60% of your deposit in more DAI
3. Deposit the borrowed DAI into BenQi again
4. Borrow some more DAI against that
...
If you don’t want to go through the hassle of looping, a platform like [YieldYak](https://yieldyak.com/) , an autocompounder, does this automatically.
...
**Disclaimer:** There are many projects that deserve recognition but can’t fit on here. We encourage you to find *more projects here:* [https://avaxnftstats.com/](https://avaxnftstats.com/)
...
If you can afford a team, it is simple to buy the crabs off of the Crabada marketplace: [https://marketplace.crabada.com/](https://marketplace.crabada.com/)

**RPG Gaming — DeFi Kingdoms**

DeFi Kingdoms combines all the mechanics of DeFi (staking, swapping, NFTs) with the feel of a RPG. You can purchase hero NFTs and go on quests. You can also do normal DeFi actions like we discuss above (staking, liquidity providing) in the context of the game. You can learn more [here.](https://medium.com/@Samichpunch/beginners-guide-to-defi-kingdoms-how-to-start-playing-defi-kingdoms-88e9041467d2#248c)
...
- **Requirements** :[Solidity](https://blog.logrocket.com/writing-smart-contracts-solidity/) , Hardhat3

3. Build a frontend to interact with smart contract

- **Requirements** :[React](https://blog.logrocket.com/tag/react) , Next.js, Ethers.js, Metamask

4. Hosting the application

- **Requirements** : Vercel

To learn about the full process for developing your dApp, read more [here](https://blog.logrocket.com/build-dapp-avalanche-complete-guide/). Avalanche itself also has some very helpful docs: [https://docs.avax.network/build/tutorials/platform/launch-your-ethereum-dapp/](https://docs.avax.network/build/tutorials/platform/launch-your-ethereum-dapp/)
...
- [Emin Gun Sirer](https://twitter.com/el33th4xor) : Founder of the whole project
- [Kevin Sekniqi](https://twitter.com/kevinsekniqi) : Chief Protocol Architect
- [Luigi D’Onorio DeMeo](https://twitter.com/luigidemeo) : Head of DeFi, masterminding new frontiers for DeFi
- [Farid Rached](https://twitter.com/FaridRached) : Ecosystem Growth, knows all the upcoming projects
- [Jay Kurahashi-Sofue:](https://twitter.com/jayks17) VP of Marketing, summarizes all the developments happening
- [Gabriel Cardona](https://twitter.com/cgcardona) : Developer evangelist
- [Connor Daly](https://twitter.com/das_connor) : Developer and builder
