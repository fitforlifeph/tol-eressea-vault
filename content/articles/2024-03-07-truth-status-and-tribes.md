---
title: "Truth, Status, and Tribes"
author: "Erik Torenberg"
publication: "Erik Torenberg"
published: 2021-08-01
saved: 2024-03-07T07:24:33.498784+00:00
created: 2024-03-07T07:24:33.498784+00:00
source: "https://eriktorenberg.substack.com/p/truth-status-and-tribes"
estimated_pages: 13
status: complete
draft: false
tags: []
...
For the sake of this piece, let’s hold this assumption as true: people often act in the interest of increasing their social status within a tribe. Not you or me of course — we do things out of altruism, honor, and integrity—I’m referring to *other people.*

The idea of increasing one’s status often carries negative connotations — conjuring up imagery of political jockeying and impurity of intentions. That’s not what I’m talking about. Instead I’m referring to “increasing status” in the positive sense: to accomplish or contribute towards something that increases others’ estimation of your value.

As Nassim Taleb puts it in his book [Antifragile](https://www.amazon.com/dp/B009K6DKTS/ref=dp-kindle-redirect?_encoding=UTF8&btkr=1), anything done with the explicit intent to improve one’s status likely *won’t* improve one’s status. Status is a very specific game: any time you think about the game, you lose. After all, the most respected people achieved their status as a byproduct of altruism, honor, and integrity. Respected people possess positive reputations — this is the same thing as status. As you read, try to see status seeking as synonymous with improving one's reputation.
...
So we self-deceive by signaling. Robin Hanson and Kevin Simler wrote [a whole book on](https://www.amazon.com/Elephant-Brain-Hidden-Motives-Everyday/dp/0190495995) how we send signals across nearly every element of our lives. While true and fascinating, many people don’t want to hear that. What a buzzkill!

But constantly self-deceiving is exhausting. For one you have to fabricate. You have to parrot high-status opinions while deceiving others and yourself of your motives. Of course this exhaustion implies that humans are evolved to accurately perceive reality in the first place, but that’s unlikely. As mentioned, we just aren’t evolved to prioritize objective reality if it doesn’t mean increasing our status score.

Consider the Desktop computer interface as an analogy. If you’re writing an email and the icon for email is red and rectangular, that doesn’t mean the email itself in your computer is red & rectangular. It's an interface. It's not meant to show you the truth (the resistors, circuits, and software—complicated stuff!).
...
Circling back to status and reputation: It’s important to note that, when we’re talking about increasing status, we’re talking in the context of increasing status *within a tribe*. Everything makes much more sense when we understand that people are hard-wired to choose a tribe, stick within it, and defend it unconditionally. We can’t live without tribes. You need a tribe to help you grow food, defend you from enemies, and mate.  Perhaps seeing objective reality was more evolutionarily fit for solitary humans who didn’t live in tribes, since they were too busy finding food and shelter to focus on signaling and self-deceiving. But social animals are different. They have to rise up within tribes and avoid freeloaders.

To be clear, the fact that objective reality is sometimes deprioritized doesn’t mean everyone is a liar. As George Constanza once said “It’s not a lie if you believe it.” In all seriousness, lying implies people are *consciously* deceiving, but since people deceive *themselves* in the process, that’s likely not the case. Brains aren’t built to accurately represent facts; they’re built to help navigate social situations, and self-deception is a valuable skill for doing that. But self-deception isn’t the right term either because deception also implies deliberateness, whereas this manipulation is subconsciously done at the filtering level. Your brain doesn’t pick between objective reality and the version of reality that increases the status score; it’s unclear whether it even filters for the former at all—except when it overlaps with the latter. 
...
To illustrate how tribal our reasoning is, I’ll refer to Scott Alexander’s old post called “[I Can Tolerate Anything Except The Outgroup](https://slatestarcodex.com/2014/09/30/i-can-tolerate-anything-except-the-outgroup/)”, explaining why the center-left seems to hate, say, Margaret Thatcher or Milton Friedman, more than Osama Bin Laden. It’s because the Blue Tribe's outgroup isn’t Al-Qaeda or Antifa or campus activists — it’s the Red Tribe. The Red tribe's outgroup isn’t Russia or Trump or even the most extreme evangelical Christians — it’s the Blue Tribe. If you're in the center, you join the tribe that keeps you safe. To quote SSC:
...
To be sure, life has gotten [less zero-sum over time](https://eriktorenberg.substack.com/p/the-rise-of-positive-sum-thinking). As we increasingly move from scarcity to abundance, hopefully status acquisition will become more positive sum, and mistake theory will increasingly be the correct lens to apply—and as a result seeking truth will be more aligned with social cohesion. 

Maybe that’s the silver lining of this piece: As the world becomes more positive-sum over time, truth and social cohesion are able to better co-exist.
